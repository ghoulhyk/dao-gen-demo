...
func NewRawWhereCondItem[T any](op base.Op, sql string, args ...any) *RawWhereCondItem {
...
func NewWhereCondItem[T any](op base.Op, column string) *WhereCondItem[T] {
...
func (receiver *RawWhereCondItem) GetOp() base.Op {
	return receiver.op
}
...
func (receiver *WhereCondItem[T]) GetOp() base.Op {
	return receiver.op
}
